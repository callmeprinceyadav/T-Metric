        ...
        <div style={{ bg: "white" }}>
          ...
          <div className={style.signupadsection}>
            <div className={style.signupadsection1}>
              ...
              <p style={{cursor:"pointer"}} >Log In with Google</p>
            </div>
            ...
            <div className={style.signupadsection1}>
              <img
                ...
                alt=""
              />
              <p style={{cursor:"pointer"}} >Log In with Microshoft</p>
            </div>
            <div className={style.signupadsection1}>
              <img src="https://id.tmetric.com/images/apple_logo.svg" alt="" />
              <p style={{cursor:"pointer"}} >Log In with Apple</p>
            </div>

            <hr className={style.signupadsechr} />

            <div className={style.signupadsechrunder}>
              <p style={{ color: "blue",cursor:"pointer" }}>Can't Log In?</p>

              <p style={{ color: "blue",cursor:"pointer" }}>Sign Up</p>
            </div>
          </div>
        </div>
      </div>
